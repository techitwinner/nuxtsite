...
export default defineNuxtConfig({
  ...
  modules: ['@nuxtjs/tailwindcss', '@nuxtjs/i18n', 'nuxt-anchorscroll', 'nuxt-aos', '@nuxtjs/strapi', '@formkit/auto-animate', '@nuxt/image', '@nuxt/icon', '@nuxtjs/color-mode', 'shadcn-nuxt', '@nuxtjs/seo'],
